...
export class PrismaAppointmentMapper {
    ...
    return Appointment.create(
      {
        ...
        service: BookedServiceSnapshot.create({
          ...
          category: raw.bookedServiceCategory,
          durationInMinutes: raw.bookedServiceDurationInMinutes,
  ...
  static toPrisma(raw: Appointment): Prisma.AppointmentUncheckedCreateInput {
    return {
      ...
      bookedServiceCategory: raw.service.category,
      bookedServiceDurationInMinutes: raw.service.durationInMinutes,
