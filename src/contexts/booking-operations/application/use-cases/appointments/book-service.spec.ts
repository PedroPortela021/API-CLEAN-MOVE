import { InactiveServiceError } from "../../../domain/catalog/errors/inactive-service-error";
import { EstimatedDuration } from "../../../domain/catalog/value-objects/estimated-duration";
