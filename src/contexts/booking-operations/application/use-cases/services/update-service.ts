...
import { InvalidServiceNameError } from "../../../domain/catalog/value-objects/service-name";
import { InvalidEstimatedDurationError } from "../../../domain/catalog/value-objects/estimated-duration";
import { InvalidMoneyError } from "../../../domain/catalog/value-objects/money";
import { InvalidEstimatedDurationTransitionError } from "../../../domain/catalog/errors/invalid-estimated-duration-transition-error";
